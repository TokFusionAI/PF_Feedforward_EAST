...
示例 (DCU 节点, 先 source DTK env)::
    ...
    python paper_igbt/export_all_slices.py --shot 134925
"""
...
from paper_igbt.freegsnke_infer import infer_one_shot_best  # noqa: E402 (需 torch/DCU)
...
def main() -> int:
    ...
    ap.add_argument("--ckpt", type=str, default=str(BEST_CKPT))
    ...
    inf = infer_one_shot_best(shot, args.ckpt, device=args.device)
