...
def main() -> int:
    ...
    ap.add_argument("--metrics", default="results/paper_igbt/eval_test/metrics_summary.json")
    ap.add_argument("--out", default="results/paper_igbt/figures/constraint_satisfaction.png")
    args = ap.parse_args()
    ...
    ax.bar(x + w / 2, pred * 100, w, label="BC prediction (best model)", color="#DC2626")
