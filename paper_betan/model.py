"""加载paper model (transformer_bidir_on, seed s44; 双向 Transformer + 物理时间正弦位置编码) —— 走 ablation.build_model (非 bc.CausalTransformer)。
...
def load_paper_model(ckpt: str | Path = MODEL_CKPT, device: str = "cuda:0"):
