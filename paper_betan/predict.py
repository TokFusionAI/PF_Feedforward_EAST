...
用法(计算节点): python -m paper_betan.predict [--limit N]
"""
...
from paper_betan.model import MODEL_CKPT, load_paper_model  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--out", default="results/paper_betan/predictions/per_shot_preds.npz")
    args = ap.parse_args()

    device = args.device if torch.cuda.is_available() else "cpu"
    model, cfg, extra = load_paper_model(args.ckpt, device)
