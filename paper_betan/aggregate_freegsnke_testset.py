...
用法 (所有 shard 跑完后):
  python -m paper_betan.aggregate_freegsnke_testset [--in-dir results/paper_betan/freegsnke_testset]
"""
...
def main() -> int:
    ...
    ap.add_argument("--in-dir", default="results/paper_betan/freegsnke_testset")
