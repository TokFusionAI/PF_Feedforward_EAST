...
def main() -> int:
    ...
    from paper_betan.freegsnke_infer import infer_one_shot_best
    from paper_betan.model import BEST_CKPT
    ...
    for si, shot in enumerate(shots, 1):
        try:
            ...
            inf = infer_one_shot_best(shot, args.ckpt, run_model=(args.current_source == "pred"))
        except Exception as e:
